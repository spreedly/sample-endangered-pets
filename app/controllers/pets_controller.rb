class PetsController < ApplicationController
  ...
  def transparent_redirect_complete
    ...
    response = SpreedlyCore.purchase(@payment_method, order.amount, order_id: order.id, redirect_url: pets_offsite_redirect_url, callback_url: pets_offsite_callback_url)
